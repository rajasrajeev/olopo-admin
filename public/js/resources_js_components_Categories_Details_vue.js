(self["webpackChunk"] = self["webpackChunk"] || []).push([["resources_js_components_Categories_Details_vue"],{

/***/ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/Categories/Details.vue?vue&type=script&lang=js":
/*!************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/Categories/Details.vue?vue&type=script&lang=js ***!
  \************************************************************************************************************************************************************************************************************/
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    playVideo: function playVideo(thumbnail) {
      var video = thumbnail.querySelector('video');
      var overlay = thumbnail.querySelector('.play-button-overlay');
      if (video.paused) {
        // Play the video
        video.play();
    ...
    getCategoryDetails: function getCategoryDetails() {
      var _this = this;
      var loading = this.block("categoryDetailLoading");
      var url = this.categoryId ? "/api/v1/category-details/".concat(this.categoryId) : '/api/v1/category-details';
    ...
    getCategories: function getCategories() {
      ...
      this.axios.get("/api/v1/categories").then(function (response) {
        ...
        if (_this2.categoryId && _this2.categories.length > 0) {
          _this2.addPostData.category_id = parseInt(_this2.categoryId);
        }
      })["catch"](function (error) {
    ...
    getGalleryItems: function getGalleryItems() {
      ...
      this.axios.get("/api/v1/gallery").then(function (response) {
        _this3.galleryItems = response.data.data;
      })["catch"](function (error) {
    ...
    addCategoryDetail: function addCategoryDetail() {
      ...
      var loading = this.block("addDetailForm");
      ...
      if (this.addPostData.accordions.length > 0) {
        this.addPostData.accordions.forEach(function (accordion, index) {
          formData.append("accordions[".concat(index, "][question]"), accordion.question);
          formData.append("accordions[".concat(index, "][answer]"), accordion.answer || '');
        });
      }
      this.axios.post('/api/v1/add/category-detail', formData, {
        ...
        _this4.errorNotification(((_error$response4 = error.response) === null || _error$response4 === void 0 || (_error$response4 = _error$response4.data) === null || _error$response4 === void 0 ? void 0 : _error$response4.message) || 'Error occurred');
        loading.close();
      });
    },
    // Add this new method to sync editor contents
    syncEditorContents: function syncEditorContents() {
      var _this5 = this;
      this.addPostData.accordions.forEach(function (accordion, index) {
        var editorId = "add-editor-".concat(index);
        if (_this5.editors[editorId]) {
          accordion.answer = _this5.editors[editorId].root.innerHTML;
        }
      });
    },
    updateCategoryDetail: function updateCategoryDetail() {
      var _this6 = this;
      var loading = this.block("editDetailForm");
      var formData = new FormData();
      ...
      this.axios.post("/api/v1/update/category-detail/".concat(this.editPostData.id), formData, {
        headers: {
          'Content-Type': 'multipart/form-data'
        }
      }).then(function (response) {
        _this6.editDetailModel = false;
        ...
        _this6.editDetailModel = false;
        _this6.errorNotification(((_error$response5 = error.response) === null || _error$response5 === void 0 || (_error$response5 = _error$response5.data) === null || _error$response5 === void 0 ? void 0 : _error$response5.message) || 'Error occurred');
        loading.close();
      });
    },
    // Content management
    manageContent: function manageContent(item) {
      this.selectedDetail = _objectSpread({}, item);
      this.manageContentModel = true;
    },
    // Update the addAccordion method to ensure proper editor initialization
    addAccordion: function addAccordion(formType) {
      var _this7 = this;
      if (formType === 'add') {
        var newIndex = this.addPostData.accordions.length;
        ...
        this.$nextTick(function () {
          ...
          setTimeout(function () {
            _this7.initializeEditor("add-editor-".concat(newIndex), '', newIndex, 'add');
          }, 100);
        });
      }
    },
    // Update the removeAccordion method to clean up editors
    removeAccordion: function removeAccordion(formType, index) {
      var _this8 = this;
      if (formType === 'add') {
        ...
        this.$nextTick(function () {
          setTimeout(function () {
            _this8.addPostData.accordions.forEach(function (accordion, newIndex) {
              var newEditorId = "add-editor-".concat(newIndex);
              if (document.getElementById(newEditorId)) {
                _this8.initializeEditor(newEditorId, accordion.answer, newIndex, 'add');
              }
            });
          }, 100);
        });
    ...
    addAccordionToDetail: function addAccordionToDetail() {
      var _this9 = this;
      this.accordionData = {
        question: '',
        answer: ''
      ...
      this.$nextTick(function () {
        _this9.initializeEditor('accordion-editor');
      });
    },
    editAccordion: function editAccordion(accordion, index) {
      var _this0 = this;
      this.accordionData = _objectSpread({}, accordion);
      this.isEditing = true;
      this.editingAccordionIndex = index;
      this.addAccordionModel = true;
      this.$nextTick(function () {
        _this0.initializeEditor('accordion-editor', accordion.answer);
      });
    },
    saveAccordion: function saveAccordion() {
      var _this1 = this;
      ...
      if (this.isEditing) {
        formData.append('_method', 'PUT');
        this.axios.put("/api/v1/category-detail/".concat(this.selectedDetail.id, "/accordion/").concat(this.accordionData.id), formData).then(function (response) {
          _this1.addAccordionModel = false;
          _this1.successNotification(response.data.message);
          _this1.refreshDetailContent();
        })["catch"](function (error) {
          var _error$response6;
          _this1.errorNotification(((_error$response6 = error.response) === null || _error$response6 === void 0 || (_error$response6 = _error$response6.data) === null || _error$response6 === void 0 ? void 0 : _error$response6.message) || 'Error occurred');
        });
      } else {
        this.axios.post('/api/v1/category-detail/' + this.selectedDetail.id + '/accordion', formData).then(function (response) {
          _this1.addAccordionModel = false;
          _this1.successNotification(response.data.message);
          _this1.refreshDetailContent();
        })["catch"](function (error) {
          var _error$response7;
          _this1.errorNotification(((_error$response7 = error.response) === null || _error$response7 === void 0 || (_error$response7 = _error$response7.data) === null || _error$response7 === void 0 ? void 0 : _error$response7.message) || 'Error occurred');
        });
      }
    },
    deleteAccordion: function deleteAccordion(accordionId) {
      this.deleteType = 'accordion';
      this.deleteId = accordionId;
      this.deleteDialog = true;
    },
    // Video management
    addVideoToDetail: function addVideoToDetail() {
      this.videoData = {
        title: '',
        video_path: null,
        thumbnail: null,
    ...
    editVideo: function editVideo(video) {
      this.videoData = _objectSpread({}, video);
      this.addVideoModel = true;
    },
    handleVideoUpload: function handleVideoUpload(event) {
      this.videoData.videoFile = event.target.files[0];
    },
    handleVideoThumbnailUpload: function handleVideoThumbnailUpload(event) {
    ...
    saveVideo: function saveVideo() {
      ...
      this.axios.post('/api/v1/category-detail/' + this.selectedDetail.id + '/video', formData, {
        ...
        _this10.addVideoModel = false;
        _this10.successNotification(response.data.message);
        _this10.refreshDetailContent();
      })["catch"](function (error) {
        var _error$response8;
        _this10.errorNotification(((_error$response8 = error.response) === null || _error$response8 === void 0 || (_error$response8 = _error$response8.data) === null || _error$response8 === void 0 ? void 0 : _error$response8.message) || 'Error occurred');
      });
    },
    ...
    // Image management
    addImageToDetail: function addImageToDetail() {
      this.selectedGalleryImage = null;
      this.addImageModel = true;
    },
    selectGalleryImage: function selectGalleryImage(galleryId) {
    ...
    saveImage: function saveImage() {
      ...
      this.axios.post('/api/v1/category-detail/' + this.selectedDetail.id + '/image', formData).then(function (response) {
        _this11.addImageModel = false;
        _this11.successNotification(response.data.message);
        _this11.refreshDetailContent();
      })["catch"](function (error) {
        var _error$response9;
        _this11.errorNotification(((_error$response9 = error.response) === null || _error$response9 === void 0 || (_error$response9 = _error$response9.data) === null || _error$response9 === void 0 ? void 0 : _error$response9.message) || 'Error occurred');
      });
    },
    ...
    confirmDelete: function confirmDelete() {
      ...
      switch (this.deleteType) {
        case 'detail':
          deleteUrl = "/api/v1/delete/category-detail/".concat(this.deleteId);
          break;
        case 'accordion':
          deleteUrl = "/api/v1/category-detail/".concat(this.selectedDetail.id, "/accordion/").concat(this.deleteId);
          break;
        case 'video':
          deleteUrl = "/api/v1/category-detail/".concat(this.selectedDetail.id, "/video/").concat(this.deleteId);
          break;
        case 'image':
          deleteUrl = "/api/v1/category-detail/".concat(this.selectedDetail.id, "/image/").concat(this.deleteId);
          break;
      }
      this.axios["delete"](deleteUrl).then(function (response) {
        _this12.deleteDialog = false;
        _this12.successNotification(response.data.message);
        if (_this12.deleteType === 'detail') {
          _this12.getCategoryDetails();
        } else {
          _this12.refreshDetailContent();
        }
      })["catch"](function (error) {
        var _error$response0;
        _this12.deleteDialog = false;
        _this12.errorNotification(((_error$response0 = error.response) === null || _error$response0 === void 0 || (_error$response0 = _error$response0.data) === null || _error$response0 === void 0 ? void 0 : _error$response0.message) || 'Error occurred');
      });
    },
    handleBannerUpload: function handleBannerUpload(event, formType) {
    ...
    getImageUrl: function getImageUrl(imagePath) {
      return "/public/storage/".concat(imagePath);
    },
    refreshDetailContent: function refreshDetailContent() {
      var _this13 = this;
      // Refresh the selected detail with updated content
      this.axios.get("/api/v1/get/category-detail/".concat(this.selectedDetail.id)).then(function (response) {
        _this13.selectedDetail = response.data.data;
        _this13.getCategoryDetails(); // Also refresh the main list
      })["catch"](function (error) {
        var _error$response1;
        console.log((_error$response1 = error.response) === null || _error$response1 === void 0 ? void 0 : _error$response1.data);
      });
    },
    resetAddForm: function resetAddForm() {
      ...
      // Destroy all editors
      for (var editorId in this.editors) {
        if (this.editors[editorId]) {
          delete this.editors[editorId];
        }
      }
    },
    initializeEditor: function initializeEditor(containerId) {
      var _this14 = this;
      var content = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : '';
      var index = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : null;
      var formType = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : null;
      this.$nextTick(function () {
        var container = document.getElementById(containerId);
        if (container) {
          // Clear any existing editor
          if (_this14.editors[containerId]) {
            delete _this14.editors[containerId];
            container.innerHTML = '';
          }
          var quill = new quill__WEBPACK_IMPORTED_MODULE_0__["default"]("#".concat(containerId), {
            theme: 'snow',
            modules: {
          ...
          _this14.editors[containerId] = quill;

          // Set up proper event handlers
          if (containerId === 'accordion-editor') {
            _this14.currentAccordionEditor = quill;
          } else if (formType === 'add' && index !== null) {
            // Real-time sync for add form accordions
            quill.on('text-change', function () {
              if (_this14.addPostData.accordions[index]) {
                _this14.addPostData.accordions[index].answer = quill.root.innerHTML;
              }
            });

            // Also sync on blur to ensure content is captured
            quill.on('selection-change', function (range) {
              if (!range && _this14.addPostData.accordions[index]) {
                _this14.addPostData.accordions[index].answer = quill.root.innerHTML;
              }
            });
          }
    ...
    block: function block(elementId) {
      return {
...
/***/ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/Categories/Details.vue?vue&type=template&id=67dfeb5a&scoped=true":
/*!***********************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/Categories/Details.vue?vue&type=template&id=67dfeb5a&scoped=true ***!
  \***********************************************************************************************************************************************************************************************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
var render = function render() {
  ...
  return _c("div", [_c("div", {
    ...
    staticClass: "btn btn-sm btn-neutral mr-2",
    on: {
    ...
    on: {
      click: function click($event) {
        _vm.addDetailModel = !_vm.addDetailModel;
      }
    }
  }, [_vm._v("\n                            New Detail\n                        ")])])])])])]), _vm._v(" "), _c("div", {
    ...
    return _c("tbody", {
      ...
      attrs: {
        src: _vm.getImageUrl(item.banner_image)
      }
    }) : _c("span", [_vm._v("No Banner")])]), _vm._v(" "), _c("td", [_c("span", {
      ...
      staticClass: "status"
    }, [_vm._v(_vm._s(item.status ? "Active" : "Inactive"))])])]), _vm._v(" "), _c("td", [_c("span", {
      staticClass: "badge badge-primary"
    }, [_vm._v(_vm._s(item.accordions ? item.accordions.length : 0))])]), _vm._v(" "), _c("td", [_c("span", {
      staticClass: "badge badge-info"
    }, [_vm._v(_vm._s(item.videos ? item.videos.length : 0))])]), _vm._v(" "), _c("td", [_c("span", {
      staticClass: "badge badge-warning"
    }, [_vm._v(_vm._s(item.images ? item.images.length : 0))])]), _vm._v(" "), _c("td", [_c("div", {
      staticStyle: {
        display: "inline-flex"
      }
    }, [_c("button", {
    ...
    scopedSlots: _vm._u([{
      ...
      fn: function fn() {
        ...
        }, [_vm._v("\n                Add New "), _c("b", [_vm._v("Category Detail")])])];
      },
      proxy: true
    }]),
    model: {
      value: _vm.addDetailModel,
      callback: function callback($$v) {
        _vm.addDetailModel = $$v;
      },
      expression: "addDetailModel"
    }
  }, [_vm._v(" "), _c("form", {
    attrs: {
      id: "addDetailForm"
    ...
    directives: [{
      name: "model",
      rawName: "v-model",
      value: _vm.addPostData.category_id,
      expression: "addPostData.category_id"
    }],
    ...
    on: {
      change: function change($event) {
        ...
        _vm.$set(_vm.addPostData, "category_id", $event.target.multiple ? $$selectedVal : $$selectedVal[0]);
      }
    }
  }, [_c("option", {
    attrs: {
    ...
    staticClass: "form-control-label"
  }, [_vm._v("Banner Image")]), _vm._v(" "), _c("input", {
    staticClass: "form-control",
    attrs: {
      type: "file",
      accept: "image/*"
    ...
    on: {
      change: function change($event) {
        return _vm.handleBannerUpload($event, "add");
      }
    }
  })]), _vm._v(" "), _c("div", {
    staticClass: "form-group"
    ...
    staticClass: "form-control-label"
  }, [_vm._v("Accordions")]), _vm._v(" "), _c("button", {
    ...
    on: {
      click: function click($event) {
        return _vm.addAccordion("add");
      }
    }
  }, [_c("i", {
    staticClass: "fas fa-plus"
  }), _vm._v(" Add Accordion\n                ")]), _vm._v(" "), _vm._l(_vm.addPostData.accordions, function (accordion, index) {
    return _c("div", {
      key: index,
      ...
      staticClass: "form-control-label"
    }, [_vm._v("Question")]), _vm._v(" "), _c("input", {
      directives: [{
        name: "model",
        rawName: "v-model",
        value: accordion.question,
        expression: "accordion.question"
      }],
      staticClass: "form-control",
      attrs: {
        type: "text",
      ...
      on: {
        input: function input($event) {
          if ($event.target.composing) return;
          _vm.$set(accordion, "question", $event.target.value);
        }
      }
    })])]), _vm._v(" "), _c("div", {
      staticClass: "col-md-12"
      ...
      on: {
        click: function click($event) {
          return _vm.removeAccordion("add", index);
        }
      }
    }, [_c("i", {
  ...
  }, [_vm._v("Add Category Detail")])])])]), _vm._v(" "), _c("vs-dialog", {
    attrs: {
      "prevent-close": "",
      blur: "",
      width: "800px"
    ...
    scopedSlots: _vm._u([{
      ...
      fn: function fn() {
        return [_c("h4", {
          staticClass: "not-margin"
        }, [_vm._v("\n                Edit "), _c("b", [_vm._v("Category Detail")])])];
      },
      proxy: true
    }]),
    model: {
      value: _vm.editDetailModel,
      callback: function callback($$v) {
        _vm.editDetailModel = $$v;
      },
      expression: "editDetailModel"
    }
  }, [_vm._v(" "), _c("form", {
    attrs: {
      id: "editDetailForm"
    ...
    on: {
      submit: function submit($event) {
        $event.preventDefault();
        return _vm.updateCategoryDetail();
      }
    }
  }, [_c("div", {
    staticClass: "row"
    ...
    directives: [{
      name: "model",
      rawName: "v-model",
      value: _vm.editPostData.category_id,
      expression: "editPostData.category_id"
    }],
    staticClass: "form-control",
    attrs: {
      required: ""
    ...
    on: {
      change: function change($event) {
        ...
        _vm.$set(_vm.editPostData, "category_id", $event.target.multiple ? $$selectedVal : $$selectedVal[0]);
      }
    }
  }, [_c("option", {
    attrs: {
    ...
    staticClass: "form-control-label"
  }, [_vm._v("Current Banner")]), _vm._v(" "), _vm.editPostData.banner_image ? _c("div", [_c("img", {
    ...
    attrs: {
      src: _vm.getImageUrl(_vm.editPostData.banner_image)
    }
    ...
    on: {
      change: function change($event) {
        return _vm.handleBannerUpload($event, "edit");
      }
    }
  })]), _vm._v(" "), _c("div", {
    staticClass: "form-group"
  ...
  }, [_vm._v("Update Category Detail")])])])]), _vm._v(" "), _c("vs-dialog", {
    attrs: {
      "prevent-close": "",
      blur: "",
      fullscreen: ""
    ...
    scopedSlots: _vm._u([{
      ...
      fn: function fn() {
        return [_c("h4", {
          staticClass: "not-margin"
        }, [_vm._v("\n                Manage Content for "), _c("b", [_vm._v(_vm._s(_vm.selectedDetail.title))])])];
      },
      proxy: true
    }, {
      key: "footer",
    ...
    model: {
      value: _vm.manageContentModel,
      callback: function callback($$v) {
        _vm.manageContentModel = $$v;
      },
      expression: "manageContentModel"
    }
  }, [_vm._v(" "), _c("div", {
    staticClass: "container-fluid"
  }, [_c("ul", {
    ...
    staticClass: "mb-0"
  }, [_vm._v("Accordions")])]), _vm._v(" "), _c("div", {
    staticClass: "col-auto"
  }, [_c("button", {
    staticClass: "btn btn-primary btn-sm",
    on: {
      click: function click($event) {
        return _vm.addAccordionToDetail();
      }
    }
  }, [_c("i", {
    staticClass: "fas fa-plus"
    ...
    staticClass: "card-body"
  }, [_vm._l(_vm.selectedDetail.accordions, function (accordion, index) {
    return _c("div", {
      key: accordion.id,
      staticClass: "card mb-3"
    }, [_c("div", {
      ...
      staticClass: "col-md-12"
    }, [_c("h5", [_vm._v(_vm._s(accordion.question))]), _vm._v(" "), _c("div", {
      staticClass: "mb-3",
      domProps: {
        innerHTML: _vm._s(accordion.answer)
      }
    }), _vm._v(" "), _c("button", {
      staticClass: "btn btn-sm btn-primary mr-2",
      on: {
        click: function click($event) {
          return _vm.editAccordion(accordion, index);
        }
      }
    }, [_c("i", {
      ...
      on: {
        click: function click($event) {
          return _vm.deleteAccordion(accordion.id);
        }
      }
    }, [_c("i", {
      staticClass: "fas fa-trash"
    }), _vm._v(" Delete\n                                            ")])])])])]);
  }), _vm._v(" "), !_vm.selectedDetail.accordions || _vm.selectedDetail.accordions.length === 0 ? _c("div", {
    staticClass: "text-center"
  }, [_c("p", [_vm._v("No accordions available")])]) : _vm._e()], 2)])]), _vm._v(" "), _c("div", {
    ...
    staticClass: "mb-0"
  }, [_vm._v("Videos")])]), _vm._v(" "), _c("div", {
    staticClass: "col-auto"
  }, [_c("button", {
    staticClass: "btn btn-primary btn-sm",
    on: {
      click: function click($event) {
        return _vm.addVideoToDetail();
      }
    }
  }, [_c("i", {
    staticClass: "fas fa-plus"
    ...
    staticClass: "row"
  }, _vm._l(_vm.selectedDetail.videos, function (video) {
    return _c("div", {
      key: video.id,
      ...
      staticClass: "card-body"
    }, [_c("h6", [_vm._v(_vm._s(video.title))]), _vm._v(" "), video.thumbnail ? _c("div", [_c("img", {
      staticClass: "img-fluid mb-2",
      staticStyle: {
        "max-height": "100px"
      },
      attrs: {
        src: _vm.getImageUrl(video.thumbnail)
      }
    })]) : _vm._e(), _vm._v(" "), _c("p", {
      staticClass: "text-sm"
    }, [_vm._v(_vm._s(video.description))]), _vm._v(" "), _c("button", {
      staticClass: "btn btn-sm btn-primary mr-2",
      on: {
        click: function click($event) {
  ...
  }), 0), _vm._v(" "), !_vm.selectedDetail.videos || _vm.selectedDetail.videos.length === 0 ? _c("div", {
    staticClass: "text-center"
  }, [_c("p", [_vm._v("No videos available")])]) : _vm._e()])])]), _vm._v(" "), _c("div", {
    staticClass: "tab-pane fade",
    attrs: {
      id: "images",
      role: "tabpanel"
    ...
    staticClass: "row"
  }, _vm._l(_vm.selectedDetail.images, function (image) {
    return _c("div", {
      key: image.id,
      ...
      attrs: {
        src: _vm.getImageUrl(image.gallery.image_path)
      }
    }), _vm._v(" "), _c("div", {
      staticClass: "card-body"
    }, [_c("h6", [_vm._v(_vm._s(image.gallery.title))]), _vm._v(" "), _c("button", {
      staticClass: "btn btn-sm btn-danger",
      on: {
        click: function click($event) {
  ...
  }), 0), _vm._v(" "), !_vm.selectedDetail.images || _vm.selectedDetail.images.length === 0 ? _c("div", {
    staticClass: "text-center"
  }, [_c("p", [_vm._v("No images available")])]) : _vm._e()])])])])])]), _vm._v(" "), _c("vs-dialog", {
    attrs: {
      "prevent-close": "",
      blur: "",
      width: "700px"
    ...
    scopedSlots: _vm._u([{
      ...
      fn: function fn() {
        return [_c("h4", {
          staticClass: "not-margin"
        }, [_vm._v("Add "), _c("b", [_vm._v("Accordion")])])];
      },
      proxy: true
    }]),
    model: {
      value: _vm.addAccordionModel,
      callback: function callback($$v) {
        _vm.addAccordionModel = $$v;
      },
      expression: "addAccordionModel"
    }
  }, [_vm._v(" "), _c("form", {
    attrs: {
      id: "addAccordionForm"
    ...
    directives: [{
      name: "model",
      rawName: "v-model",
      value: _vm.accordionData.question,
      expression: "accordionData.question"
    }],
    staticClass: "form-control",
    attrs: {
      type: "text",
    ...
    on: {
      input: function input($event) {
        if ($event.target.composing) return;
        _vm.$set(_vm.accordionData, "question", $event.target.value);
      }
    }
  })]), _vm._v(" "), _c("div", {
    staticClass: "form-group"
  ...
  }, [_vm._v("Save Accordion")])])])]), _vm._v(" "), _c("vs-dialog", {
    attrs: {
      "prevent-close": "",
      blur: "",
      width: "600px"
    ...
    scopedSlots: _vm._u([{
      ...
      fn: function fn() {
        return [_c("h4", {
          staticClass: "not-margin"
        }, [_vm._v("Add "), _c("b", [_vm._v("Video")])])];
      },
      proxy: true
    }]),
    model: {
      value: _vm.addVideoModel,
      callback: function callback($$v) {
        _vm.addVideoModel = $$v;
      },
      expression: "addVideoModel"
    }
  }, [_vm._v(" "), _c("form", {
    attrs: {
      id: "addVideoForm"
    ...
    directives: [{
      name: "model",
      rawName: "v-model",
      value: _vm.videoData.title,
      expression: "videoData.title"
    }],
    staticClass: "form-control",
    attrs: {
      type: "text",
    ...
    on: {
      input: function input($event) {
        if ($event.target.composing) return;
        _vm.$set(_vm.videoData, "title", $event.target.value);
      }
    }
  })]), _vm._v(" "), _c("div", {
    staticClass: "form-group"
    ...
    staticClass: "form-control-label"
  }, [_vm._v("Video File")]), _vm._v(" "), _c("input", {
    staticClass: "form-control",
    attrs: {
      type: "file",
      accept: "video/*",
    ...
    on: {
      change: _vm.handleVideoUpload
    }
  })]), _vm._v(" "), _c("div", {
    staticClass: "form-group"
  }, [_c("label", {
    staticClass: "form-control-label"
  }, [_vm._v("Thumbnail")]), _vm._v(" "), _c("input", {
    staticClass: "form-control",
    attrs: {
      type: "file",
      accept: "image/*"
    ...
    on: {
      change: _vm.handleVideoThumbnailUpload
    }
  })]), _vm._v(" "), _c("div", {
    staticClass: "form-group"
  }, [_c("label", {
    ...
    directives: [{
      name: "model",
      rawName: "v-model",
      value: _vm.videoData.description,
      expression: "videoData.description"
    }],
    staticClass: "form-control",
    attrs: {
    ...
    on: {
      input: function input($event) {
        if ($event.target.composing) return;
        _vm.$set(_vm.videoData, "description", $event.target.value);
      }
    }
  })]), _vm._v(" "), _c("div", {
    staticClass: "footer-dialog text-center"
  ...
  }, [_vm._v("Save Video")])])])]), _vm._v(" "), _c("vs-dialog", {
    attrs: {
      "prevent-close": "",
      blur: "",
      width: "600px"
    ...
    scopedSlots: _vm._u([{
      ...
      fn: function fn() {
        return [_c("h4", {
          staticClass: "not-margin"
        }, [_vm._v("Add "), _c("b", [_vm._v("Image")])])];
      },
      proxy: true
    }]),
    model: {
      value: _vm.addImageModel,
      callback: function callback($$v) {
        _vm.addImageModel = $$v;
      },
      expression: "addImageModel"
    }
  }, [_vm._v(" "), _c("div", {
    staticClass: "form-group"
  }, [_c("label", {
    staticClass: "form-control-label"
  }, [_vm._v("Select from Gallery")]), _vm._v(" "), _c("div", {
    staticClass: "row"
    ...
    return _c("div", {
      ...
      "class": {
        "border-primary": _vm.selectedGalleryImage === galleryItem.id
      },
      on: {
        click: function click($event) {
          return _vm.selectGalleryImage(galleryItem.id);
        }
      }
    }, [_c("img", {
      staticClass: "card-img-top",
      ...
      attrs: {
        src: _vm.getImageUrl(galleryItem.image_path)
      }
    }), _vm._v(" "), _c("div", {
    ...
    staticClass: "btn btn-primary",
    attrs: {
      disabled: !_vm.selectedGalleryImage
    },
    on: {
      click: function click($event) {
  ...
  }, [_c("p", [_vm._v("Are you sure you want to delete this item?")])])])], 1);
};
var staticRenderFns = [function () {
  ...
  }, [_vm._v("Accordions")]), _vm._v(" "), _c("th", {
    staticClass: "sort",
    attrs: {
      scope: "col"
    }
  }, [_vm._v("Videos")]), _vm._v(" "), _c("th", {
    staticClass: "sort",
    attrs: {
      scope: "col"
    }
  ...
  var _vm = this,
    _c = _vm._self._c;
  return _c("span", [_c("strong", [_vm._v("Manage")])]);
}, function () {
  var _vm = this,
    _c = _vm._self._c;
...
/***/ "./node_modules/laravel-mix/node_modules/css-loader/dist/cjs.js??clonedRuleSet-9.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-9.use[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/Categories/Details.vue?vue&type=style&index=0&id=67dfeb5a&scoped=true&lang=css":
/*!*********************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/laravel-mix/node_modules/css-loader/dist/cjs.js??clonedRuleSet-9.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-9.use[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/Categories/Details.vue?vue&type=style&index=0&id=67dfeb5a&scoped=true&lang=css ***!
  \*********************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
/***/ ((module, __webpack_exports__, __webpack_require__) => {
...
// Module
___CSS_LOADER_EXPORT___.push([module.id, "\n.cursor-pointer[data-v-67dfeb5a] {\n    cursor: pointer;\n}\n.editor-container[data-v-67dfeb5a] {\n    min-height: 150px;\n}\n.nav-tabs .nav-link[data-v-67dfeb5a] {\n    color: #525f7f;\n}\n.nav-tabs .nav-link.active[data-v-67dfeb5a] {\n    color: #5e72e4;\n    border-color: #5e72e4;\n}\n.card[data-v-67dfeb5a] {\n    box-shadow: 0 0 2rem 0 rgba(136, 152, 170, 0.15);\n}\n.badge[data-v-67dfeb5a] {\n    font-size: 0.75rem;\n}\n.table th[data-v-67dfeb5a] {\n    border-top: none;\n    font-weight: 600;\n    color: #8898aa;\n}\n.footer-dialog[data-v-67dfeb5a] {\n    padding: 1rem 0;\n}\n@media (max-width: 768px) {\n.col-md-4[data-v-67dfeb5a] {\n        margin-bottom: 1rem;\n}\n.btn-sm[data-v-67dfeb5a] {\n        font-size: 0.75rem;\n        padding: 0.25rem 0.5rem;\n}\n}\n", ""]);
// Exports
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (___CSS_LOADER_EXPORT___);
...
/* harmony import */ var _node_modules_laravel_mix_node_modules_css_loader_dist_cjs_js_clonedRuleSet_9_use_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_clonedRuleSet_9_use_2_node_modules_vue_loader_lib_index_js_vue_loader_options_Details_vue_vue_type_style_index_0_id_67dfeb5a_scoped_true_lang_css__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! !!../../../../node_modules/laravel-mix/node_modules/css-loader/dist/cjs.js??clonedRuleSet-9.use[1]!../../../../node_modules/vue-loader/lib/loaders/stylePostLoader.js!../../../../node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-9.use[2]!../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./Details.vue?vue&type=style&index=0&id=67dfeb5a&scoped=true&lang=css */ "./node_modules/laravel-mix/node_modules/css-loader/dist/cjs.js??clonedRuleSet-9.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-9.use[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/Categories/Details.vue?vue&type=style&index=0&id=67dfeb5a&scoped=true&lang=css");
...
var update = _node_modules_style_loader_dist_runtime_injectStylesIntoStyleTag_js__WEBPACK_IMPORTED_MODULE_0___default()(_node_modules_laravel_mix_node_modules_css_loader_dist_cjs_js_clonedRuleSet_9_use_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_clonedRuleSet_9_use_2_node_modules_vue_loader_lib_index_js_vue_loader_options_Details_vue_vue_type_style_index_0_id_67dfeb5a_scoped_true_lang_css__WEBPACK_IMPORTED_MODULE_1__["default"], options);
...
/***/ "./resources/js/components/Categories/Details.vue":
/*!********************************************************!*\
  !*** ./resources/js/components/Categories/Details.vue ***!
  \********************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _Details_vue_vue_type_template_id_67dfeb5a_scoped_true__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./Details.vue?vue&type=template&id=67dfeb5a&scoped=true */ "./resources/js/components/Categories/Details.vue?vue&type=template&id=67dfeb5a&scoped=true");
/* harmony import */ var _Details_vue_vue_type_script_lang_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./Details.vue?vue&type=script&lang=js */ "./resources/js/components/Categories/Details.vue?vue&type=script&lang=js");
/* harmony import */ var _Details_vue_vue_type_style_index_0_id_67dfeb5a_scoped_true_lang_css__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./Details.vue?vue&type=style&index=0&id=67dfeb5a&scoped=true&lang=css */ "./resources/js/components/Categories/Details.vue?vue&type=style&index=0&id=67dfeb5a&scoped=true&lang=css");
...
var component = (0,_node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_3__["default"])(
  ...
  _Details_vue_vue_type_template_id_67dfeb5a_scoped_true__WEBPACK_IMPORTED_MODULE_0__.render,
  _Details_vue_vue_type_template_id_67dfeb5a_scoped_true__WEBPACK_IMPORTED_MODULE_0__.staticRenderFns,
  false,
  null,
  "67dfeb5a",
  null
...
{ var api; }
component.options.__file = "resources/js/components/Categories/Details.vue"
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (component.exports);

/***/ }),

/***/ "./resources/js/components/Categories/Details.vue?vue&type=script&lang=js":
/*!********************************************************************************!*\
  !*** ./resources/js/components/Categories/Details.vue?vue&type=script&lang=js ***!
  \********************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./resources/js/components/Categories/Details.vue?vue&type=style&index=0&id=67dfeb5a&scoped=true&lang=css":
/*!****************************************************************************************************************!*\
  !*** ./resources/js/components/Categories/Details.vue?vue&type=style&index=0&id=67dfeb5a&scoped=true&lang=css ***!
  \****************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_style_loader_dist_cjs_js_node_modules_laravel_mix_node_modules_css_loader_dist_cjs_js_clonedRuleSet_9_use_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_clonedRuleSet_9_use_2_node_modules_vue_loader_lib_index_js_vue_loader_options_Details_vue_vue_type_style_index_0_id_67dfeb5a_scoped_true_lang_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../node_modules/style-loader/dist/cjs.js!../../../../node_modules/laravel-mix/node_modules/css-loader/dist/cjs.js??clonedRuleSet-9.use[1]!../../../../node_modules/vue-loader/lib/loaders/stylePostLoader.js!../../../../node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-9.use[2]!../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./Details.vue?vue&type=style&index=0&id=67dfeb5a&scoped=true&lang=css */ "./node_modules/style-loader/dist/cjs.js!./node_modules/laravel-mix/node_modules/css-loader/dist/cjs.js??clonedRuleSet-9.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-9.use[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/Categories/Details.vue?vue&type=style&index=0&id=67dfeb5a&scoped=true&lang=css");


/***/ }),

/***/ "./resources/js/components/Categories/Details.vue?vue&type=template&id=67dfeb5a&scoped=true":
/*!**************************************************************************************************!*\
  !*** ./resources/js/components/Categories/Details.vue?vue&type=template&id=67dfeb5a&scoped=true ***!
  \**************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   render: () => (/* reexport safe */ _node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_lib_loaders_templateLoader_js_ruleSet_1_rules_2_node_modules_vue_loader_lib_index_js_vue_loader_options_Details_vue_vue_type_template_id_67dfeb5a_scoped_true__WEBPACK_IMPORTED_MODULE_0__.render),
/* harmony export */   staticRenderFns: () => (/* reexport safe */ _node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_lib_loaders_templateLoader_js_ruleSet_1_rules_2_node_modules_vue_loader_lib_index_js_vue_loader_options_Details_vue_vue_type_template_id_67dfeb5a_scoped_true__WEBPACK_IMPORTED_MODULE_0__.staticRenderFns)
/* harmony export */ });
/* harmony import */ var _node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_lib_loaders_templateLoader_js_ruleSet_1_rules_2_node_modules_vue_loader_lib_index_js_vue_loader_options_Details_vue_vue_type_template_id_67dfeb5a_scoped_true__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!../../../../node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./Details.vue?vue&type=template&id=67dfeb5a&scoped=true */ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/Categories/Details.vue?vue&type=template&id=67dfeb5a&scoped=true");
